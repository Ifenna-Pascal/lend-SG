...
const NavBar = () => {
  ...
  return (
    <nav className=" bg-black px-6  flex justify-between my-auto  w-full md:px-[2rem] lg:px-16 sticky top-0 z-50">
      <div className="flex h-[44px] w-full md:h-[55px] lg:h-[64px] xl:h-[74px] justify-between items-center">
        <Image
          src={logo}
          alt="logo"
          width={100}
          height={100}
          className="w-[60px] md:w-[80px] lg:w-[120px] xl:w-[135px] "
        />
