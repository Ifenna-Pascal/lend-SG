  ...
  return (
    <div className="  bg-[#000000]  bg-cover bg-center px-3  bg-opacity-100   text-white  ">
      <div className="max-w-[2000px]  mx-auto  ">
        <div>
          <div className="lg:px-16 mx-auto  py-3 md:py-8">
            <h1 className="text-[34px]  md:text-[40px]  mt-3 md:mt-[-5rem] lg:mt-[-6rem] xl:mt-[-8rem] text-center md:text-left  leading-[26px] md:leading-[32px]  lg:text-[48px]  lg:leading-[46.5px] xl:leading-[52px]  font-sora text-[#01F8AF] font-bold w-full px-2 md:px-4 lg:px-5  xl:px-0 ">
              $ 234,429.22
            </h1>
            <p className="text-[12px] md:text-[14px] lg:text-[20px] text-white text-opacity-60  font-sora text-center md:px-4 px-0 lg:px-5 xl:px-1 md:text-left font-light  mt-1 md:mt-3">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-6 xl:gap-12 mt-0 md:mt-[1rem] mx-auto  ">
            {data.map((item) => (
              <div
                key={item.id}
                data-aos="flip-left"
                className="mt-7 md:mt-0 border w-[295px] h-[470px] md:h-[380px] lg:h-[450px] xl:w-[430px] bg-[#03130E]  border-[#01F9AF] rounded-md  "
              >
                <div className=" flex h-full flex-col items-center px-6 justify-center overflow-hidden ">
                  <Image
                    src={item.img}
                    alt="icons"
                    width={100}
                    height={100}
                    className="w-[180px] md:w-[180px] lg:w-[190px] h-[170px] font-sora  lg:h-[200px]"
                  />
          ...
          <div className="flex flex-col-reverse md:flex-row py-8 md:items-center   space-x-0 md:space-x-4 lg:flex-row mt-[3rem]  ">
            <div className="w-full md:w-[50%] flex flex-col space-y-4 md:space-y-0 px-0  md:px-0">
              <Image
                src={docimage}
                alt="contact"
                className="md:w-[75%]"
            ...
            <div className="w-full md:w-[40%]  mt-0 md:mt-6 lg:mt-0 px-0 lg:px-4 ">
              <h4
                data-aos="fade-top"
                className="font-orbitron text-center md:text-left   text-[12px]/[15px] font-sora font-bold mt-6 md:text-[14px]/[18px] text-[#01F9AF] lg:text-[14px]/[20px] xl:text-[18px]/[22px]  md:mt-0  "
              >
                ABOUT US
              </h4>
              ...
              <p
                data-aos="flip-up"
                className="font-orbitron  text-[#E1E1E1] text-center md:text-left text-[10px]/[15px] font-helvatica font-light mt-3 md:text-[12px]/[24px] lg:text-[10px]/[22px] xl:text-[16px]/[30px] md:mt-3   "
              >
                {" "}
