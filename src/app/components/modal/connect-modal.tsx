...
const Wallet = ({ img, name }: IProp) => {
  return (
    <div className=" mb-4  py-2 cursor-pointer px-2 flex items-center justify-between  bg-gray-300 rounded-[7px] max-w-[80%] mx-auto">
      <span className="text-[#000000] text-[19px] py-3 flex items-center justify-center text-center  font-sora">
        {name}
      </span>
      <Image
        src={img}
...
const WalletConnectModal = ({ close }: { close: () => void }) => {
  return (
    <div className="border border-[#FFFFFF66] min-h-[500px]  rounded-md w-[550px] bg-[#FFFFFF]">
      <div className="w-full border-b  py-4 relative border-[#FFFFFF66] ">
        ...
        />
        <h2 className="font-sora text-[38px] text-black text-center font-semibold">
          Connect a Wallet
        </h2>
        <h3 className="font-sora text-[20px] text-gray-500 text-center font-light">
      ...
      <span className="text-black flex items-center justify-center pb-8 pt-5 py-16 font-semibold text-[14px]">
