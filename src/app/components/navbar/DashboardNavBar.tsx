...
//           <Link href={"/"}>
//             <div className="">
//               <Image src={logo} alt="logo" width={100} height={100} className="w-[80px] h-[34px] lg:w-[151px] lg:h-[64px]" />
//             </div>
//           </Link>
...
//               console.log(active)
//               const routelink = pathname
//               const linkref = link.href
//               console.log(linkref, "this is the linkref")
//               console.log(routelink, "this is the route link")

//               return (
//                 <Link href={link.href} key={index}>
//                   <span
//                     className={`${(routelink === "/dashboard/market" || routelink === "/dashboard/staking" || routelink === "/dashboard/more" || routelink === "/dashboard ") ? "border-b-2 border-[#01F8AF] pb-[15px] lg:pb-[22px] "  : " "} pb-3 font-montserrat text-white font-semibold text-[10px]/[12px] md:text-[12px]/[15px] lg:text-[14px]
//                    xl:text-[16px]/[20px]`}
//                   >
//                     {link.title}
//                   </span>
