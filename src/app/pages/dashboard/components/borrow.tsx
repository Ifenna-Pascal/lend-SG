...
const Borrowtable = () => {
  return (
    <div className="overflow-x-auto py-6  w-full lg:w-1/2 ">
      <div className=" flex flex-col rounded-md border border-[#3b3c3c] bg-[#030D0A] mb-6 px-2 md:px-2 lg:px-6 py-6 ">
          ...
          <table className="  min-w-full divide-y font-sora  divide-[#FFFFFF1A] ">
            <thead className="bg-transparent">
              <tr className="h-[85px]">
                <th
                  scope="col"
                  className="md:px-5 lg:px-6 py-5  text-left text-[10px]/[10px] font-sora text-gray-400 text-light-200 font-semibold"
                >
                ...
                return (
                  ...
                  >
                    <td className="lg:px-1 xl:px-6 py-7 whitespace-nowrap">
                      <div className="md:ml-1 lg:ml-4 flex items-center">
