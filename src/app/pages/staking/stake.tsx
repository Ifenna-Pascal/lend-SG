  ...
  return (
    <div>
      ...
      <div className="flex-col mx-auto bg-[#181b19] px-4 md:px-8 lg:px-10 xl:px-20 border-gray-400">
        ...
        <div className=" flex items-center gap-3 mt-6  mb-9">
          <Button
            variant={"primary"}
            className="w-1/2 h-[50px] text-[14px]/[15px] md:[18px]/[18px] lg:[24px]/[18px] xl:text-[30px]/[37px] font-sora font-semibold"
          >
            Stake
          </Button>
          <Button
