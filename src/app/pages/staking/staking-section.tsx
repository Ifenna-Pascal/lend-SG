  ...
  return (
    <div className="">
      <div className=" w-full ">
        <div className="mx-auto w-[80%]  gap-2 justify-around px-6  lg:w-[800px] mt-9 xl:w-[1139px] h-[700px] lg:h-[900px] xl:h-[1073px] bg-[#1A1A1A] bg-opacity-[60%] border border-[#FFFFFF] border-opacity-10 shadow-xl  rounded-[15px]  items-center">
